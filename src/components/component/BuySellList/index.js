              ...
              <div key={index} className="rounded-lg bg-gray-200 p-4 my-2">
                ...
                <div className="w-full bg-white rounded-lg mt-2 flex p-1">
                    ...
                    <div>
                      <span className="text-lg font-bold">
                        {showCurrency === "USD"
                          ...
                          : order.price_busd.toFixed(3)}
                      </span>
                      <span className="text-sm">
                        {showCurrency === "USD" ? "USD" : "MNT"}
                      </span>
                    </div>
                  </div>
                  <div className="w-8/12 flex items-start text-sm">
                    ...
                    <div className="w-8/12 flex flex-col font-bold">
                      <span>{order.amount_mgl} MGL</span>
                    </div>
                  </div>
                </div>
                <div className="text-center text-sm bg-green-200 mt-2 p-1 rounded-lg">
                  {order.payment_method.replace(",", "/")}
                </div>
                <div
                  className="mt-2 bg-green-500 text-white rounded-lg font-bold text-center py-4"
