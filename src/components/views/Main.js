      ...
      {!regPage ? (
        <div className="relative mb-0">
          ...
          <div className="w-11/12 xl:w-5/6 m-auto ">
            ...
            >
              <p className="text-2xl md:text-5xl 2xl:text-8xl font-bold mb-1 md:mb-2">
                {t("Buy & Sell Crypto with")}
              </p>
              <p className="text-2xl md:text-5xl 2xl:text-8xl font-bold mb-2">
                {t("MGL Exchange")}
              </p>
              {/* <p className="text-md md:hidden">{t("Join the world's largest crypto exchange")}</p> */}

              <button
                className="myButton myBule text-white px-12 mt-8 2xl:text-lg"
            ...
            >
              <div className="flex justify-between mb-4">
                <PairCardButton
                  title={props.coinData[0].name}
                  percent={props.coinData[0].percent}
                  amount1={props.coinData[0].price}
                />
                <PairCardButton
                  title={props.coinData[1].name}
                  percent={props.coinData[1].percent}
                  amount1={props.coinData[1].price}
                />
              </div>
              <div className="flex justify-between">
                <PairCardButton
                  title={props.coinData[2].name}
                  percent={props.coinData[2].percent}
                  amount1={props.coinData[2].price}
                />
                <PairCardButton
                  title={props.coinData[3].name}
                  percent={props.coinData[3].percent}
