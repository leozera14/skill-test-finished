...
class WalletController {
  ...
  accessWalletByPrivateKey = async (req, res, next) => {
    try {
      const result = await WalletService.accessWalletWithPrivateKey(
        req.body,
        req.currentUser.id
      );
      res.send(result);
  ...
  accessWalletWithKeyphrase = async (req, res, next) => {
    try {
      const result = await WalletService.accessWalletWithKeyphrase(
        req.body,
        req.currentUser.id
      );
      res.send(result);
  ...
  getCurrentEthPrice = async (req, res, next) => {
    try {
      const result = await WalletService.getCurrentEthPrice(
        req.body,
        req.currentUser.id
      );
      res.send(result);
  ...
  getAssets = async (req, res, next) => {
    try {
      const result = await WalletService.getAssets(
        req.body,
        req.currentUser.id
      );
      res.send(result);
  ...
  receiveToken = async (req, res, next) => {
    try {
      const result = await WalletService.receiveToken(
        req.body,
        req.currentUser.id
      );
      res.send(result);
  ...
  getSecret = async (req, res, next) => {
    try {
      const result = await WalletService.getSecret(
        req.body,
        req.currentUser.id
      );
      res.send(result);
  ...
  getCoinForTransaction = async (req, res, next) => {
    try {
      ...
      const result = await WalletService.getCoinForTransaction(
        req.body,
        req.currentUser.id
      );
      res.send(result);
